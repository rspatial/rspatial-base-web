...
There are two versions of this website, the `"terra" version </terra/index.html>`_ and the `"raster" version </raster/index.html>`_. The "terra" package is a new *R* package to replace "raster". "terra" is easier to use, has more functionality, and it is faster. So if in doubt use the `terra` version. 
