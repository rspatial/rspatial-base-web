...
Ubuntu users can follow the instructions in this [discussion on stackoverflow](https://stackoverflow.com/questions/44382368/rgdal-installation-difficulty-on-ubuntu-16-04-lts) to avoid complexity in installing some of the `spatial` packages, particularly `rgdal`.
