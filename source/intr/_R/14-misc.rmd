...
It has become quite common to use the `%>%` "piping" operator in R defined in the `magrittr` package (base *R* will introduce `|>` in version 4.1). We do not use it in our tutorials, but we show it here so that you can understand it when you come across it.
